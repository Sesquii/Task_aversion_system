#!/usr/bin/env python3
"""
PostgreSQL Migration 018: Add daily_target and daily_limit to tasks table
...
from backend.database import get_session, engine  # noqa: E402
...
def migrate() -> bool:
    ...
    print("=" * 70)
    print("PostgreSQL Migration 018: Add daily_target/daily_limit to tasks")
    print("=" * 70)
    print()
    ...
    if not database_url:
        ...
        print("Set it before running this migration.")
        return False
    ...
    with get_session() as session:
        try:
            ...
            if "tasks" not in inspector.get_table_names():
                ...
                print("Run initial schema migration first.")
                return False
