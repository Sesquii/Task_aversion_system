#!/usr/bin/env python
"""
Migration 007: Create UserPreferences Table
...
def migrate():
    ...
    print("=" * 70)
    print("Migration 007: Create UserPreferences Table")
    print("=" * 70)
    print("\nThis migration creates the user_preferences table.")
    ...
    try:
        ...
        if table_exists('user_preferences'):
            ...
            # Check that JSON columns exist
            print("\nChecking JSON column types...")
            ...
            for col_name in json_columns:
                if col_name in column_types:
                    ...
                    if 'JSON' in col_type or 'TEXT' in col_type:
                        print(f"   [OK] '{col_name}' column uses JSON/TEXT type")
                    else:
